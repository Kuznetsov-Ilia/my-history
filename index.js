...
function History() {
  ...
  if (typeof _window$1 !== 'undefined') {
    this.location = location;
    this.history = _window$1.history;
  }
}
...
Object.assign(Eventable(History.prototype), {
  ...
  atRoot() {
    ...
    start(options) {
      ...
      this._hasHashChange = 'onhashchange' in _window$1 && (document.documentMode === void 0 || document.documentMode > 7);
      ...
      if (this._usePushState) {
        _window$1.on('popstate', this.checkUrl);
      } else if (this._useHashChange && !this.iframe) {
        _window$1.on('hashchange', this.checkUrl);
    ...
    stop() {
      ...
      if (this._usePushState) {
        _window$1.off('popstate', this.checkUrl, false);
      } else if (this._useHashChange && !this.iframe) {
        _window$1.off('hashchange', this.checkUrl, false);
      }
